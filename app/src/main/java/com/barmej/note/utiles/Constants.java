...
public class Constants {
    ...
    public static final String KEY_OF_INTENT_NOTE_IMEGE_URI = "KEY OF INTENT NOTE IMEGE URI";
    public static final String KEY_OF_INTENT_NOTE_COlOR = "KEY OF INTENT NOTE COLOR";
